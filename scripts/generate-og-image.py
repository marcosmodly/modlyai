...
def generate_og_image():
    ...
    print("saved public/og-default.png", canvas.size)


def generate_schema_logo():
    # Google's Organization.logo guidance: a real raster image, >=112x112,
    # solid background rather than transparency. Center the ribbon mark on
    # a square canvas so it qualifies.
    SIZE = 512
    BG = (255, 255, 255)
    ...
    canvas.save("public/logo-schema.png")
    print("saved public/logo-schema.png", canvas.size)


if __name__ == "__main__":
    generate_og_image()
    generate_schema_logo()
