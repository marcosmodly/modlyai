...
export default function Shop() {
  return (
    <main className="min-h-screen bg-dark-surface">
      {/* Hero Section (Consumer Version) */}
      <section className="relative px-6 py-24 md:py-40 bg-dark-base overflow-hidden">
        {/* Subtle gradient background overlay */}
        <div className="absolute inset-0 bg-gradient-ai-subtle opacity-50" />
        ...
        <div className="relative max-w-7xl mx-auto text-center z-10">
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-text-secondary mb-12 max-w-3xl mx-auto leading-relaxed">
            Experience AI-powered furniture design and planning. Upload room photos, chat with our AI assistant, and get
            intelligent recommendations tailored to your space.
          </p>
      ...
      <section className="px-6 py-24 md:py-32 bg-dark-surface">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-text-primary text-center mb-16">How It Works</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            <div className="bg-dark-card p-8 lg:p-10 rounded-lg shadow-soft border border-subtle hover:border-ai-primary/30 transition-all duration-300 group">
              ...
              <h3 className="text-2xl font-semibold text-text-primary mb-4 text-center">Upload Your Room</h3>
              <p className="text-text-secondary text-center leading-relaxed">
                Take photos of your space and provide room dimensions. Our AI analyzes your room&apos;s layout, style, and
                available space.
              </p>
            </div>
            ...
            <div className="bg-dark-card p-8 lg:p-10 rounded-lg shadow-soft border border-subtle hover:border-ai-primary/30 transition-all duration-300 group">
              ...
              <h3 className="text-2xl font-semibold text-text-primary mb-4 text-center">AI Recommendations</h3>
              <p className="text-text-secondary text-center leading-relaxed">
                Get personalized furniture recommendations with detailed dimensions, materials, colors, and placement
            ...
            <div className="bg-dark-card p-8 lg:p-10 rounded-lg shadow-soft border border-subtle hover:border-ai-primary/30 transition-all duration-300 group">
              ...
              <h3 className="text-2xl font-semibold text-text-primary mb-4 text-center">Customize & Design</h3>
              <p className="text-text-secondary text-center leading-relaxed">
                Customize furniture with AI assistance - change colors, materials, add ornaments, and see how dimensions
      ...
      <section className="relative px-6 py-24 md:py-32 bg-dark-base overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center z-10">
          <h2 className="text-4xl md:text-5xl font-bold text-text-primary mb-6">Ready to Transform Your Space?</h2>
