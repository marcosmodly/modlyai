...
import { removeCustomizedFurniture } from '@/utils/customizedFurnitureStorage';
...
export default function CustomizedFurnitureList({ items, onItemRemoved }: CustomizedFurnitureListProps) {
  ...
  if (items.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <a
          href="/customizer"
          className="inline-block px-6 py-3 bg-earth-forest text-white rounded-xl font-semibold hover:bg-earth-forest/90 transition-all duration-300"
        >
          Go to Customizer
        </a>
      </div>
