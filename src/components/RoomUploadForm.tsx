...
export default function RoomUploadForm({ onUpload, isLoading, onPhotosChange, formRef }: RoomUploadFormProps) {
    ...
    <form ref={formElementRef} onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-[#242723] border border-[#3A3F38] rounded-xl p-6">
        ...
        <select
          ...
          onChange={(e) => setDimensions({ ...dimensions, roomType: e.target.value as RoomDimensions['roomType'] })}
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    min="0"
                    value={lengthFeet || ''}
                    onChange={(e) => setLengthFeet(parseInt(e.target.value) || 0)}
                    placeholder="ft"
                    className="w-full px-4 py-2.5 border border-earth-border rounded-lg bg-white text-[#1A1C19] focus:outline-none focus:ring-2 focus:ring-earth-sage focus:ring-opacity-50 focus:border-earth-sage transition-all placeholder:text-[#757575]"
                    required
                  />
                  <input
                    ...
                    max="11"
                    value={lengthInches || ''}
                    onChange={(e) => setLengthInches(Math.min(11, parseInt(e.target.value) || 0))}
                    placeholder="in"
                    className="w-full px-4 py-2.5 border border-earth-border rounded-lg bg-white text-[#1A1C19] focus:outline-none focus:ring-2 focus:ring-earth-sage focus:ring-opacity-50 focus:border-earth-sage transition-all placeholder:text-[#757575]"
                  />
                </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <input
                    ...
                    max="11"
                    value={widthInches || ''}
                    onChange={(e) => setWidthInches(Math.min(11, parseInt(e.target.value) || 0))}
                    placeholder="in"
                    className="w-full px-4 py-2.5 border border-earth-border rounded-lg bg-white text-[#1A1C19] focus:outline-none focus:ring-2 focus:ring-earth-sage focus:ring-opacity-50 focus:border-earth-sage transition-all placeholder:text-[#757575]"
                  />
                </div>
          ...
          <div className="px-6 pb-6 pt-4 space-y-6 border-t border-[#3A3F38]">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setPreferences({ ...preferences, colors: e.target.value.split(',').map(s => s.trim()).filter(Boolean) })}
                className="w-full px-4 py-2.5 border border-earth-border rounded-lg bg-white text-[#1A1C19] focus:outline-none focus:ring-2 focus:ring-earth-sage focus:ring-opacity-50 focus:border-earth-sage transition-all placeholder:text-[#757575]"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setPreferences({ ...preferences, budget: { ...preferences.budget, min: parseInt(e.target.value) || undefined } })}
                  className="w-full px-4 py-2.5 border border-earth-border rounded-lg bg-white text-[#1A1C19] focus:outline-none focus:ring-2 focus:ring-earth-sage focus:ring-opacity-50 focus:border-earth-sage transition-all placeholder:text-[#757575]"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setPreferences({ ...preferences, budget: { ...preferences.budget, max: parseInt(e.target.value) || undefined } })}
                  className="w-full px-4 py-2.5 border border-earth-border rounded-lg bg-white text-[#1A1C19] focus:outline-none focus:ring-2 focus:ring-earth-sage focus:ring-opacity-50 focus:border-earth-sage transition-all placeholder:text-[#757575]"
                />
              </div>
            </div>
