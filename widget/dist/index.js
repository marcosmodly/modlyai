...
function getRealProductUrl(product, storeDomain) {
...
function getProductCatalogUrl$1(item, storeDomain) {
...
function RecommendationsList({ recommendations, onCustomize, onFinalize, enabledActions, primaryColor, analyticsContext, storeDomain }) {
    ...
    return (jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [jsxRuntimeExports.jsxs("div", { children: [jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-gray-950", children: "Matching catalog products" }), jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-gray-600", children: "Suggestions are based on the uploaded room photo, your preferences, and available catalog data." })] }), jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-6", children: recommendations.map((rec, index) => {
                    const catalogUrl = getProductCatalogUrl$1(rec.item, storeDomain);
...
function FurnitureRoomPlannerWidget({ config = {}, onCustomizeItem, onNavigateToCustomizer, sampleRooms, onQuoteSubmitted, }) {
    ...
    const buildShareText = () => {
        ...
        const items = matches.length
            ? matches
                .map((r) => {
                const link = getRealProductUrl(r.item, mergedConfig.storeDomain || mergedConfig.storeUrl);
    ...
    const handleShare = async () => {
        ...
        const firstRealLink = topMatches()
            .map((r) => getRealProductUrl(r.item, mergedConfig.storeDomain || mergedConfig.storeUrl))
...
const FurnitureCustomizerWidget = require$$0.forwardRef(function FurnitureCustomizerWidget({ config = {}, onNavigateToRoomPlanner, selectedProduct: sharedSelectedProduct, onSelectedProductChange, onQuoteSubmitted }, ref) {
    ...
    const shareProductLink = require$$0.useMemo(() => {
        const realUrl = getRealProductUrl(selectedProduct, mergedConfig.storeDomain || mergedConfig.storeUrl);
        if (realUrl)
            return realUrl;
        return typeof window !== 'undefined' ? window.location.href : '';
    }, [selectedProduct, mergedConfig.storeDomain, mergedConfig.storeUrl]);
...
function MessageBubble({ message, onCustomizeItem, onAddToRoomPlanner, onViewInCatalog, enabledActions, primaryColor, messageTextColor, analyticsContext, storeDomain }) {
...
function ConversationInterface({ aiService, onCustomizeItem, onAddToRoomPlanner, onOpenRoomPlanner, onOpenCustomizer, onShowCatalog, onViewInCatalog, enabledActions, primaryColor, messageTextColor, analyticsContext, storeDomain, suggestedPrompts, }) {
