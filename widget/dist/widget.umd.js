(function (global, factory) {
  ...
  async function fetchRemoteConfig(configUrl, widgetId) {
      try {
  ...
  function RoomUploadForm({ onUpload, isLoading, onPhotosChange, formRef, initialDimensions, initialPreferences, onDimensionsChange, onPreferencesChange, }) {
      const formElementRef = require$$0$1.useRef(null);
      ...
      const [photos, setPhotos] = require$$0$1.useState([]);
      const [unitSystem, setUnitSystem] = require$$0$1.useState('meters');
      const [dimensions, setDimensions] = require$$0$1.useState(getInitialDimensions());
      ...
      const [lengthFeet, setLengthFeet] = require$$0$1.useState(initialFeetInches.lengthFI.feet);
      const [lengthInches, setLengthInches] = require$$0$1.useState(initialFeetInches.lengthFI.inches);
      const [widthFeet, setWidthFeet] = require$$0$1.useState(initialFeetInches.widthFI.feet);
      const [widthInches, setWidthInches] = require$$0$1.useState(initialFeetInches.widthFI.inches);
      const [heightFeet, setHeightFeet] = require$$0$1.useState(initialFeetInches.heightFI.feet);
      const [heightInches, setHeightInches] = require$$0$1.useState(initialFeetInches.heightFI.inches);
      const [preferences, setPreferences] = require$$0$1.useState(initialPreferences || {});
      const [showAdvanced, setShowAdvanced] = require$$0$1.useState(false);
  ...
  function RecommendationsList({ recommendations, onCustomize, onFinalize }) {
      ...
      const [showDetailsModal, setShowDetailsModal] = require$$0$1.useState(false);
  ...
  function RoomPhotoPreview({ photoUrl, showFurniture = false }) {
      const [isFullscreen, setIsFullscreen] = require$$0$1.useState(false);
  ...
  function FurnitureRoomPlannerWidget({ config = {}, onCustomizeItem, onNavigateToCustomizer }) {
      ...
      const formRef = require$$0$1.useRef(null);
  ...
  function ColorComboBox({ label, value, onChange, options, placeholder = '', disabled = false, }) {
      ...
      const [filteredOptions, setFilteredOptions] = require$$0$1.useState(options);
      const wrapperRef = require$$0$1.useRef(null);
  ...
  function FurnitureCustomizerPanel({ baseItem, onCustomize, isLoading, }) {
      const [config, setConfig] = require$$0$1.useState({
      ...
      const [customPrompt, setCustomPrompt] = require$$0$1.useState('');
      const handleSubmit = (e) => {
          e.preventDefault();
          onCustomize(config);
      };
  ...
  function FurnitureCustomizerWidget({ config = {}, onNavigateToRoomPlanner }) {
      ...
      const [selectedMaterial, setSelectedMaterial] = require$$0$1.useState('fabric');
      const [baseItem, setBaseItem] = require$$0$1.useState({
          id: 'custom-1',
...
<body>
  ...
  function FurnitureAIWidget({ config = {}, defaultTab }) {
      ...
      const apiClient = require$$0$1.useMemo(() => new ApiClient(mergedConfig), [mergedConfig]);
      const storage = require$$0$1.useMemo(() => new Storage(mergedConfig.storageKey), [mergedConfig.storageKey]);
      const aiServiceRef = require$$0$1.useRef(null);
      ...
      const [customizeItem, setCustomizeItem] = require$$0$1.useState(null);
      const [saveNotification, setSaveNotification] = require$$0$1.useState(null);
  ...
  function FurnitureAIWidgetButton({ config = {}, defaultTab = 'room-planner', buttonText = 'ModlyAI', buttonPosition = 'bottom-right', buttonStyle, className = '' }) {
      const [isOpen, setIsOpen] = require$$0$1.useState(false);
      const [isDarkMode, setIsDarkMode] = require$$0$1.useState(false);
